...
namespace UnityEngine.InputSystem
{
    ...
    public class StepCounter : Sensor
    {
        ...
        // OpenHarmony pass the stepCount as float, while Android pass it as integer.
        // Thus use AxisControl instead of IntegerControl in OpenHarmony.
        public AxisControl stepCounter { get; protected set; }
#else
        ...
        {
#if UNITY_OPENHARMONY
            stepCounter = GetChildControl<AxisControl>("stepCounter");
#else
