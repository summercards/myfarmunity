...
namespace UnityEngine.UI
{
    ...
    public static class DefaultControls
    {
        ...
        /// <summary>
        /// Create the basic UI AndroidAppView2D.
        /// </summary>
        /// <remarks>
        /// Hierarchy:
        /// (root)
        ...
        /// <param name="resources">The resources to use for creation.</param>
        /// <returns>The root GameObject of the created element.</returns>
        public static GameObject CreateAndroidAppView2D(Resources resources)
        {
            GameObject go = CreateUIElementRoot("Android App View 2D", s_ImageElementSize, typeof(AndroidAppView2D));
            return go;
        }
